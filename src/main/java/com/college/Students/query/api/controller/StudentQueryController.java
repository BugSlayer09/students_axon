...
public class StudentQueryController {
    ...
    public String crossDomain() {
        ...
        String url = "http://localhost:8090/students/endpoint"; // Replace with the URL of the target microservice

        // You can pass request parameters, headers, and a request body if required
